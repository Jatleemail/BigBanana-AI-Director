        ...
        {episodeInfo ? (
          <>
            ...
            <button
              ...
              className="text-xs text-[var(--accent-text)] hover:underline truncate block mb-2 text-left"
            >
              <FolderOpen className="w-3 h-3 inline mr-1" />
              {episodeInfo.projectTitle}
            </button>
            <div className="text-[10px] text-[var(--text-muted)] uppercase tracking-widest mb-1">
              当前集数
            </div>
            <div className="text-sm font-medium text-[var(--text-secondary)] truncate font-mono">
        ...
        {navItems.map((item) => {
          ...
          return (
            <button
              ...
              title={
                isLocked ? "生成任务进行中，切换页面将导致数据丢失" : undefined
              }
            >
